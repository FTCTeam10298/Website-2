    ...
    return (
        <div className="footer">
            <ul className="copyright">
                ...
                <li className="icon"><a href="https://www.facebook.com/ftc10298brainstormz/" target="_blank"><img src="src/components/footer/footer_assets/icon-facebook.svg"/></a></li>
                <li className="icon"><a href="https://www.instagram.com/brain_stormz/" target="_blank"><img src="src/components/footer/footer_assets/icon-instagram.svg"/></a></li>
            </ul>
        </div>
    );
}
